...
<html>
  ...
  <body>
   <s:iterator var="totalSize" value="#request.listWayBillsDGMA2BP" status="ghindex">
   <s:set var="bean" value="#totalSize"/>
    ...
    <table style="height:9.4cm;width:7.5cm;margin-top:0.2cm;border:#000 1px solid;">
    <tr valign="top">
    <td>
    <div style="height:1.5cm;">
    <div style="float:left;width:7cm;margin-top:1mm;text-align:center;">
    <img src="barcode.br?hrsize=0mm&type=code128&ewbcode_type=&msg=<s:property value="@com.baiqian.web.util.StrUtil@repString(#bean.Cwcw_customerewbcode)" />" alt="条码" style="width:5.2cm;height:1cm;" />
   </div>
    <div style="height:0.3cm;width:7cm;text-align:center;"><span style="font-size:12px;"><b><s:property value='#bean.Cwcw_customerewbcode' /></b></span></div>
    </div> 
     ...
     <table align="center" border="0" cellspacing="0" cellpadding="0" style="width:7.3cm;border:1px #000 solid;clear:both;">
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
           ...
           <td style="width:1.8cm;"><b>DGM(X40)</b></td></tr>   
         ...
         <div style="clear:both;"></div>
            	...
            	<p style="border-bottom:1px #000 solid;width:5.3cm;text-align:center;"><s:property value="@com.baiqian.web.util.StrUtil@splitString2(#bean.Cwcw_serverewbcode)" /></p>
            	...
            	<div style="clear:both;"></div>
            	<s:if test="\"DE\".equals(#bean.Dtdt_hubcode)">
            		<div style="margin-left:5mm;font-size:11px;font-family:Arial, Helvetica, sans-serif;margin-top:0.0cm;">
