...
<html>
  ...
  <body style="margin:0px;">
    <s:iterator var="totalSize" value="#request.listWayBillsGMDE" status="ghindex">
	 ...
	 <tr><td style="width:10cm;" valign="top">
       ...
       <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
        <td style="width:10cm;clear:both">
         <div style="width:10cm;height:4.5cm;border-bottom:2px #000 solid; margin-left:0.2cm;margin-right:0.2cm;">
        
        <div style="float:left;width:4.5cm;height:4.5cm;word-wrap:break-word;" align="left">
        <br style="line-height:30%"/><b>DGMHK</b>
        ...
        <div style="float:left;width:5.5cm;height:4.5cm;">
         ...
         <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value='#bean.Cwcw_customerewbcode'/></b></div></div>
          </td></tr>
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
           ...
           <tr style="line-height:30%;"><td colspan="3">&nbsp;</td></tr>
           </table>
          </td></tr>
           <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
           <td align="center">
           <div style="width:9.4cm;height:2.5cm;margin-left:0.3cm;border-top:2px #000 solid;" align="center">
	...
	<s:if test="!('C_GMDE'.equals(#request.bl)&&(#ghindex.index+1)==#request.listWayBillsGMDE.size())"> 
