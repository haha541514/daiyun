...
<html>
  ...
  <body style="margin:0px;">
    <s:iterator var="totalSize" value="#request.listWayBillsGMEXDE" status="ghindex">
    <s:set var="bean" value="#totalSize"/>
    <table align="center" border="0" cellspacing="0" cellpadding="0" style="margin-top:0.7cm;">
	 <tr><td style="width:10cm;" valign="top">
       <table align="center" cellpadding="0" cellspacing="0" border="0" style="width:10cm;height:14.5cm;">
       <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
        <td style="clear:both">
        <div style="width:10cm;height:4.3cm;border-bottom:2px #000 solid; margin-left:0.3cm;margin-right:0.3cm;">
        
        <div style="float:left;width:4.5cm;height:4.3cm;word-wrap:break-word;font-size:12px;" align="left"><b>DGMHK</b>
        ...
        <div style="float:left;width:5.5cm;height:4.3cm;">
         <div  class="div" style="width:5.5cm; height:3.1cm;" >
          <img src="../images/cell2.jpg" style="margin:0px;height:8px;width:5.5cm;padding: 0px;display:block"/>
          <div style="float:left;marign:5px;"><img src="../images/cell.jpg" style="margin:0px;height:2.9cm;width:8px;padding: 0px;display:block"/></div>
           <div style="float:right;marign:5px;"><img src="../images/cell.jpg" style="margin:0px;height:2.9cm;width:8px;padding: 0px;display:block"/></div>
          <center>
         <table align="center" border="0" cellspacing="0" cellpadding="0"  style="width:191px;height:2.9cm;margin:0px;">       
         <tr style="font-size:10px;font-family:Arial, Helvetica, sans-serif;" align="center">
          <td colspan="2" style="width:5.2cm;" >
          <b style="font-size:12px;text-align:center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PRIORITAIRE</b></td>
         </tr>
         <tr style="font-size:10px;font-family:Arial, Helvetica, sans-serif;" align="center">
         <td style="border:2px #000 solid;width:2.9cm;border-left:none;border-bottom:none;">En cas de non remise<br/>prière de retourner à<br/><br style="line-height:70%;"/>
         <b style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;Postfach 2007<br/>&nbsp;36243 Niederaula<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ALLEMAGNE</b></td>
         <td style="border-top:2px #000 solid;width:2.3cm;"><br style="line-height:70%;"/><b style="font-size:12px;">Deutsche Post</b><br/><br style="line-height:60%;"/>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Port payé<br/>&nbsp;&nbsp;60544 Frankfurt<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Allemagne</td></tr>
         </table></center> 
         <img src="../images/cell2.jpg" style="margin:0px;background:red;height:8px;width:5.5cm;padding: 0px;display:block"/>
         </div><div style="margin-top:0.3cm;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value='#bean.Cwcw_customerewbcode'/></b></div></div></div>
          </td></tr>
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
          ...
          &nbsp;Total Value<br/>&nbsp;USD&nbsp;<s:property value="@java.lang.Double@parseDouble(#totalPrice)" /></td></tr>
           ...
           <tr style="line-height:75%;"><td colspan="3">&nbsp;</td></tr>
           </table>
          </td></tr>
           <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
           <td align="center">
           <div style="width:9.8cm;height:2.5cm;border-top:2px #000 solid;" align="center">
           <div style="float:left;height:1.8cm;width:1.2cm;margin-top:0.2cm;" ><b style="font-size:70px;">&nbsp;&nbsp;R</b></div>
           <div style="float:left;height:1.8cm;width: 6cm;margin-top:0.3cm;margin-left:1.2cm;">
            <p style="border-bottom:1px #000 solid;width:5cm;"><b><s:property value='#bean.Cwcw_serverewbcode' /></b></p>
          <img src="barcode.br?hrsize=0mm&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" alt="条码" style="width: 5.2cm;height: 1.1cm;margin-top:0.15cm;" /></div>
          </div><div style="margin-left:0cm;" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EINSCHREIBEN</div></td></tr>
       </table>
       </td></tr>
    </table>
	<s:if test="!('C_GMEXDE'.equals(#request.bl)&&(#ghindex.index+1)==#request.listWayBillsGMEXDE.size())"> 
