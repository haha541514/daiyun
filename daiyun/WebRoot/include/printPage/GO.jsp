...
<html>
  ...
  <body >
    <s:iterator var="totalSize" value="#request.listWayBillsGO" status="ghindex">
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" style="margin-top:0.5cm;">
	 <tr><td style="width:9.8cm;height:13.9cm;border:2px #000 solid;" valign="top">
       <table align="center" cellpadding="0" cellspacing="0" border="0">
		 ...
		 <tr><td>
		 <div> 
		   <div style="float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;width:7.5cm;height:2.6cm;margin-left:0.4cm;border:1px #000 solid;border-bottom:none;"> 
          ...
          <tr><td align="left">
          <table align="left" cellpadding="0" cellspacing="0" border="0" style="margin-left:0.4cm;width:8.6cm;border:1px #000 solid;border-right:none;">
          <tr><td colspan="2" >
          <table align="left" border="0" cellspacing="0" cellpadding="0" style="margin-top:0.1cm;margin-left:0.2cm;width:7.5cm;border:1px #000 solid;border-bottom:none;table-layout: fixed;">
           ...
           <tr style="font-size:10px;font-family:Arial, Helvetica, sans-serif;">
          <td colspan="3"><table align="center" border="0" cellspacing="0" cellpadding="0" style="width:7.5cm;height:1.5cm;table-layout: fixed;">
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
           ...
           new SimpleDateFormat("dd-MMM-yyyy",Locale.ENGLISH).format(Calendar.getInstance().getTime())%>
            </td><td> <span style="margin-left:2cm;">HM</span>
       </td></tr>
           </table></td></tr>  
           <tr><td colspan="2" style="font-size:11px;border-top:1px #000 solid;border-bottom:1px #000 solid;">
           <div style="width:9cm;margin-left:0.4cm;" >
           <div style="float:left;height:1.2cm;width:1.2cm;margin-top:0.1cm;" ><b style="font-size:50px;font-family:Arial, Helvetica, sans-serif;">R</b></div>
           <div style="float:left;height:1.4cm;width: 6cm;margin-top:0.15cm;margin-left:0.5cm;">
            <p style="border-bottom:1px #000 solid;width:5.2cm;text-align:center;"><b ><s:property value='#bean.Cwcw_serverewbcode' /></b></p>
           <img src="barcode.br?hrsize=0mm&type=code128&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" alt="条码" style="width: 5.2cm;height: 0.7cm;margin-top:0.1cm;" /></div>
           </div><div style="margin-top:0cm;" align="left"><span style="padding-left:0.4cm;">EINSCHREIBEN</span></div></td></tr>
