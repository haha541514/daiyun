...
<html>
  ...
  <body style="margin:0px;">
    <s:iterator var="totalSize" value="#request.listWayBillsGMHKD" status="ghindex">
	 ...
	 <tr><td style="width:10cm;" valign="top">
       ...
       <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
        ...
        <div style="float:left;width:5.5cm;height:5cm;">
         ...
         <div style="width:5.1cm;text-align:center;">
          <b>REF:<s:property value='#bean.Cwcw_customerewbcode'/></b><br/>
          <img src="barcode.br?hrsize=0mm&type=code128&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" alt="条码" style="width: 5cm;height: 0.8cm;margin-top:0.15cm;" />
          <b><s:property value='#bean.Cwcw_serverewbcode' /></b></div></div></div>
          </td></tr>
