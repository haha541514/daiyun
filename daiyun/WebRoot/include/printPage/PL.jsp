...
<html>
  ...
  <body >
    <s:iterator var="totalSize" value="#request.listWayBillsPL" status="ghindex">
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" style="margin-top:0.5cm;">
	 <tr><td style="width:10cm;height:14.35cm;border:2px #000 solid;" valign="top">
       <table align="center" cellpadding="0" cellspacing="0" border="0" style="width:10cm;">
          <tr><td>
		    <div > 
		     <div style="float:left;width:4.5cm;height:2cm;font-size:13px;font-family:Arial, Helvetica, sans-serif;margin-top:0.2cm;margin-left:0.5cm;text-align:center;"></div>
		     <div style="float:left;width:4.6cm;height:2cm;font-size:8px;font-family:Arial, Helvetica, sans-serif;margin-top:0.1cm;">
		     <div style="height:1.8cm;"><div style="width:4.53cm;border:1px #000 solid;border-bottom:none;"><b style="line-height:180%;">&nbsp;</b></div>  
		     ...
		     <p style="border-top:1px #000 solid;">Luftpost/Prioritaire</p></div></div></div>
		     </div>  
		 </td></tr>
          <tr><td align="left">
