...
<html>
  ...
  <body >
    <s:iterator var="totalSize" value="#request.listWayBillsPO" status="ghindex">
       ...
       <table align="center" cellpadding="0" cellspacing="0" border="0" style="width:10cm;">
          <tr><td>
		    <div > 
		     ...
		     <div style="height:1.8cm;"><div style="width:4.53cm;border:1px #000 solid;border-bottom:none;text-align:center;"><b style="font-size:9px;">PRIORITAIRE</b></div>  
