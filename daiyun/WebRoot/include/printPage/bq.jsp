  ...
  <body>
	...
	<div style="float:left;width:7.6cm;">
		  <table align="center" cellpadding="0" cellspacing="0" style=" border-collapse: collapse;width: 7.6cm;height: 8.2cm;" >
            ...
            <tr>
              <td colspan="3" style="font-size:11px; border: 2px #000000 solid;height: auto; width:7.6cm;"><div style="font-family:Arial, Helvetica, sans-serif;margin-bottom: 2px;">
		...
		<table border="1" cellpadding="0" cellspacing="0" style="margin-top:0px; width:7.6cm;height:8.2cm; border-collapse: collapse; border: 2px #000000 solid;" >
			    <tr>
			    	<td colspan="3" style="border: 2px #000000 solid;" align="center">
					<!-- 收件人信息 -->
				    	<table border="0" cellpadding="0" cellspacing="2" width="7.6cm">
							<tr>
				        		<td colspan="2"  width="88">
					        		<div style="font-family:Arial, Helvetica, sans-serif;">
										<div align="left" style="margin-left:0.2cm; margin-top: 1.2cm;">
			...
			<s:if test="#request.listWayBillsPY.size()==0 && #request.listWayBillsGH.size()==0 && #request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0">
				<s:if test="#request.listWayBillsOTS.size()==0 && #request.listWayBillsOTSR.size()==0">
					<s:if test="(#stas.index+1)!=#request.listWayBillsBQ.size() && (#stas.index+1)%3==0">
