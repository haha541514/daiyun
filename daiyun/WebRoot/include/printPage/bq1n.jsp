...
<html>
  ...
  <body>
    <s:iterator var="totalSize" value="#request.listWayBillsBQ" status="stas">
		...
		<table align="left" cellpadding="0" cellspacing="0" style="width:7.6cm;height:8.2cm;border-collapse: collapse; border: 2px #000000 solid;" >
			    <tr>
							...
							<tr>
				        		<td colspan="2"  width="88">
					        		<div style="font-family:Arial, Helvetica, sans-serif;">
										<div align="left" style="margin-left:0.2cm; margin-top: 0.4cm;">
					        	<%--<b><s:property value="#bean.Cwcw_customerewbcode"/></b>
					        	--%>		<b><s:property value="#bean.Cwcw_ewbcode"/></b>										</div>
					    			</div>							</td>
							</tr>
							<tr>
				        		<td>
		...
		<s:if test="#request.listWayBillsOTS.size()==0 && #request.listWayBillsPY.size()==0 && #request.listWayBillsGH.size()==0 && #request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
			<s:if test="(#stas.index+1)%6==0 && (#stas.index+1) != (#request.listWayBillsBQ.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:if>
		<s:else>
			<s:if test="(#stas.index+1)%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		 </s:else>
	</s:iterator>
