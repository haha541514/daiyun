...
<html>
  ...
  <body>
   <s:iterator var="totalSize" value="#request.listWayBillsDGMP" status="ghindex">
   <s:set var="bean" value="#totalSize"/>  
    <div style="margin-top: -8px; height: 9.4cm;width: 10cm;">
    <table style="height:9.4cm;width:7.5cm;border:1px #000 solid;margin-top:0.2cm;"><tr valign="top">
    <td>
    <div style="height:1.5cm;text-align:left;"><img src="barcode.br?hrsize=0mm&type=code128&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" alt="条码" style="width:5.2cm;margin-left:1cm;height:1cm;" />
    <div style="height:0.3cm;text-align:center"><span style="font-size:13px;"><b><s:property value='#bean.Cwcw_serverewbcode' /></b></span></div></div>   
     <table align="center" border="0" cellspacing="0" cellpadding="0" style="width:7.3cm;border:1px #000 solid;clear:both;">
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
           ...
           <tr style="font-size:5px;font-family:Arial, Helvetica, sans-serif;"><td colspan="3"><span style="font-size:9px;margin-right:1cm;">ref:<s:property value='#bean.Cwcw_customerewbcode' /></span></td></tr>
           </table></td></tr></table>
    </div>
    	<div style="padding-top: 8px;height: 9.4cm;width: 10cm;">
           <table style="width:7.5cm;height:9.4cm;border:1px #000 solid;margin-top:0.2cm;"><tr valign="top"><td> 
             <div style="width:7.5cm;height:2.4cm;"><s:if test="\"DE\".equals(#bean.Dtdt_hubcode)">
