...
text-align:left;
  ...
  <body>
	...
	<div style="float:left;width:8cm;height:9.5cm;margin-left:1cm;">
	  <table  align="center" cellpadding="0" cellspacing="0" border="0" style=" border-collapse: collapse;width:7.9cm;height:8.4cm;" >
          ...
          <td height="8" colspan="3" style="border-bottom: 1px #000000 solid;height:0.7cm;"><div style="margin-left:0.2cm;">
              <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="margin-top:-1px;">
                <tr>
                  ...
                  <td width="38"><font class="fStyle2" style="line-height: 1em;font-size:8px;">Geschenk<br>
                    Cadeau</font></td>
                  <td width="20"><table width="3" height="14" align="left" cellpadding="0" cellspacing="0" style="border:1px solid #000000;width:14px;height:14px;">
                      <tr>
                        <td width="1">      
                      </table></td>
                  <td width="47"><font class="fStyle2" style="line-height: 1em;font-size:8px;">Dokumente<br>
                    Documents</font></td>
                  <td width="20"><table width="3" height="14" align="left" cellpadding="0" cellspacing="0" style="border:1px solid #000000;width:14px;height:14px;">
                      <tr>
                        <td width="1">      
                      </table></td>
                  <td width="87" ><font class="fStyle2" style="line-height: 1em;font-size:8px;">Warenmuster<br>
                    Echantillon commercial</font></td>
                  <td width="20"><table cellpadding="0" cellspacing="0" style="border:1px solid #000000;width:12px;height:12px;">
                    <tr>
                      <td style="line-height:11px;">×</td>
                    </tr>
                  </table></td>
                  <td width="41"><font class="fStyle2" style="line-height: 1em;font-size:8px;">Sonstige<br>
                    Autre</font></td>
                </tr>
              </table>
            <div  style="margin-top:0px;"><font class="fStyle2" style="font-size:8px;">Bitte ein oder mehrere Kästchen ankreuzen. Coucher la ou les cases appropriées.</font></div>
          </div></td>
        </tr>
        <tr valign="top">
          <td  style="border-bottom: 1px #000000 solid;border-left:0px;font-size:11px; width:4.7cm; "><div>
              <div align="left" style="margin-left:0.2cm; line-height:1em;width:4.6cm;"><font class="fStyle2" style="font-size:8px;">Anzahl und detaillierte Beschreibung des Inhalts(1)<br>
                Quantité et description detaillée du contenu</font> </div>
          </div></td>
          <td  style="border: 1px #000000 solid;font-size:11px;width: 1.7cm;"><div align="left" style="margin-left:0.1cm;font-size:10px;width:1.6cm;"> <font class="fStyle2" style="font-size:8px;">Gewicht(in kg)(2)<br>
            Poids (en kg)</font> </div></td>
          <td  style="border: 1px #000000 solid;border-right:0px;font-size:11px;width: 1.3cm;"><div >
              <div align="left" style="margin-left:0.1cm;width:1.1cm;"><font class="fStyle2" style="font-size:8px;">Wert(3)<br>
                Valeur</font> </div>
          </div></td>
        </tr>
        <s:set var="bean" value="#totalSize"/>
        <tr valign="top" >
          <td  style="font-size:11px; border-bottom: 1px #000000 solid;height:0.1cm; margin-top:0px;"><div style="height:1cm;margin-left:0.2cm;">
            <div style="width:4cm; float:left;">
              <s:iterator var="cargoInfo" value="@kyle.leis.eo.operation.cargoinfo.dax.CargoInfoDemand@queryAndweightByCwCode(#bean.Cwcw_code, #bean.Cwcw_customerchargeweight)" status="sta">
                  <div align="left" style="width:4cm; float:left;"> <font class="fStyle2" style="font-size:12px; "> <b>
          ...
          <td style="font-size:11px; border: 1px #000000 solid;"><s:iterator var="cargoInfo" value="@kyle.leis.eo.operation.cargoinfo.dax.CargoInfoDemand@queryAndweightByCwCode(#bean.Cwcw_code, #bean.Cwcw_customerchargeweight)" status="sta">
              <div style="margin-left:0.1cm;"><font class="fStyle2" style="font-size:11px;"> <b>
          ...
          <td style="font-size:12px; border:1px #000000 solid;border-right:0px;"><s:set var="totalPrice" value="0" />
              ...
              <s:iterator var="cargoInfo" value="@kyle.leis.eo.operation.cargoinfo.dax.CargoInfoDemand@queryAndweightByCwCode(#bean.Cwcw_code, #bean.Cwcw_customerchargeweight)" status="sta">
                <div align="left" style="font-size:10px;"> <font class="fStyle2" style="font-size:12px;"> <b>
                  <s:property value="#cargoInfo.Ckckcode"/>
        ...
        <tr>
          <td valign="top" style="border: 1px #000000 solid;border-left:0px;"><div align="left" style="margin-left:0.2cm;width:4.6cm;"><font class="fStyle2" style="font-size:8px;"><b>Nur fur Handelswaren<br>
          ...
          <td valign="top"  style="border: 1px #000000 solid;"><div style="margin-left:0.1cm; font-size:10px;width:1.6cm;"><font class="fStyle2" style="font-size:8px;">Gesamtgewicht <b>(in kg)&nbsp;</b> <b>(6)</b><br>
          ...
          <td  valign="top"  style="border: 1px #000000 solid;border-right:0px;font-size: 11px;"><div style="font-family:Arial, Helvetica, sans-serif;">
              <div align="left" style="margin-left:0.1cm;font-size:10px;"> <font class="fStyle2" style="font-size:8px;"> Gesamtwert (7)<br>
                Valeur totale </font></div>
          </div></td>
        </tr>
        <tr >
          <td style="border: 1px #000000 solid;border-left:0px;font-size: 11px; height:0.25cm;"><div align="left" style="margin-left:0.2cm;width:4.6cm; font-size:10px;height:0.2cm;" class="fstyle"><font class="fStyle2" style="font-size:8px;">CHINA/RPC</font></div></td>
          <td style="border: 1px #000000 solid; "><div style="margin-left:0.1cm;"><font class="fStyle2" style="font-size:12px;"> <b>
              <s:property value="@java.lang.Double@parseDouble(#bean.Cwcw_customerchargeweight)"/>
          </b> </font></div></td>
          <td style="border: 1px #000000 solid;border-right:0px; "><div style="margin-left:0.1cm;"><font class="fStyle2" style="font-size:12px;"> <b>
              <s:property value="#ckcode" />
            <s:property value="#totalPrice" />
          </b> </font></div></td>
        </tr>
        <tr>
          <td colspan="3" valign="top" style="font-size:11px; border: 0;height: auto; width:7.9cm;"><div align="left" style="margin-left:0.2cm; margin-top:0.1cm;  font-size:10px;backround-color:red; width:7.7cm;height:100%; "> <font class="fStyle2" style="font-size:8px;">Ich, der/die Unterzeichnende, dessen/deren Name und Adresse auf der Sendung angeführt sind, bestätige,dass die in der vorliegenden Zollinhaltserklärung angegebenen Daten korrekt sind und dass diese Sendung keine gefährlichen, gesetzlich oder auf Grund postalischer oder zollrechtlicher Regelungen verbotenen Gegenstände enthält. Ich übergebe insbesondere keine Güter, deren Versand, Beförderung oder Lagerung gemäß den AGB von Deutsche Post ausgeschlossen ist.<br>
            ...
            <font style=" font-size:8px;">Datum und Unterschrift des Absenders (8)/Date et signature de l'expéditeur:</font></font> </div>
              <div align="left" style="margin-left:0.2cm;marign-top:0.2cm;margin-bottom:0.1cm;border-bottom:dashed 1px #000; width:7.7cm;height:0.3cm;" > <font class="fStyle">
			...
			<s:set var="One" value="0"/>
			<s:set var="total" value="(#request.listWayBillsBQ.size())+(#request.listWayBillsPY.size())+(#request.listWayBillsGH.size())+(#request.listWayBillsSGGH.size())+(#request.listWayBillsSGPY.size())+(#request.listWayBillsSWGH.size())+(#request.listWayBillsOTSR.size())"/>
			<s:set var="One" value="3-((#total)%3)"/>
			
			<s:if test="(#request.listWayBillsDHLGM.size())>0">
			
				<s:if test="#One>0&&(#ghindex.index+1) == #One">
						<p style="page-break-after:always">&nbsp;</p>
				</s:if>
				<s:if test="(#ghindex.index+1-#One)%3==0">
					<p style="page-break-after:always">&nbsp;</p>
				</s:if>
			</s:if>	
	</s:iterator>
