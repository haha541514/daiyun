...
<html>
  ...
  <body>
     <s:iterator var="totalSize" value="#request.listWayBillsSGGH" status="pyindex">
		<s:set var="bean" value="#totalSize"/>
  <table align="center" style="margin-bottom:1cm;height:18cm;"><tr><td valign="top">
...
<td valign="top"><table align="center" cellpadding="0" cellspacing="0" style=" border-collapse: collapse; border: 2px #000000 solid;width: 7.6cm;height: 8.2cm;" >
  ...
  <s:if test="#request.listWayBillsSGPY.size()==0">
