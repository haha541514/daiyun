...
<html>
  ...
  <body>
	...
	<div style="float:left;height:10cm;margin-top:0.5cm;margin-left:0.5cm;">	
	...
	<s:if test="#request.listWayBillsPY.size()==0 && #request.listWayBillsGH.size()==0 && #request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
		...
		<s:else>
			<s:if test="(#staIndex.index+1+(6-#request.listWayBillsBQ.size()%6))%6==0 && (#staIndex.index+1) != (#request.listWayBillsOTS.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>		
	</s:if>
	<s:else>
		<s:if test="#request.listWayBillsBQ.size()==0">
			<s:if test="(#staIndex.index+1)%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:if>	
		<s:else>
			<s:if test="(#staIndex.index+1+(6-#request.listWayBillsBQ.size()%6))%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>	
	</s:else>
