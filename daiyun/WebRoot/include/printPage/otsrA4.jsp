...
<html>
  ...
  <body>
	...
	<s:if test="#request.listWayBillsBQ.size()==0 && #request.listWayBillsPY.size()==0 && #request.listWayBillsGH.size()==0 && #request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTS.size()==0">
		<s:if test="(#staIndex.index+1)%6==0 && (#staIndex.index+1) != #request.listWayBillsOTSR.size()">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
	</s:if>
	<s:else>
		<s:if test="#request.listWayBillsOTS.size()==0">
			<s:if test="(#staIndex.index+1+(3-(#request.listWayBillsBQ.size()+request.listWayBillsPY.size()+#request.listWayBillsGH.size()+#request.listWayBillsSGGH.size()+#request.listWayBillsSGPY.size()+#request.listWayBillsSWGH.size())%3)*2)%6==0 || (#staIndex.index+1) != #request.listWayBillsOTSR.size()">
					<p style="page-break-after:always">&nbsp;</p>
				</s:if>
		</s:if>
		<s:else>
			<s:if test="(#staIndex.index+1+(6-(3-(#request.listWayBillsBQ.size()+request.listWayBillsPY.size()+#request.listWayBillsGH.size()+#request.listWayBillsSGGH.size()+#request.listWayBillsSGPY.size()+#request.listWayBillsSWGH.size())%3)*2))%6==0 || (#staIndex.index+1) != #request.listWayBillsOTSR.size()">
					<p style="page-break-after:always">&nbsp;</p>
				</s:if>
		</s:else>
	</s:else>
