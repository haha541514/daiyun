...
<table style="border:1px dashed #999999;margin-top:0px; width:9cm; margin-bottom: 80px; border-collapse: collapse;margin-top: 1px;" cellpadding="0" cellspacing="0"><tr><td width="340" height="380">
    ...
    <td align="right"><table width="146" style="border:1px #000000 solid;font-size:13px;text-align:center;padding-left:2px;padding-right:2px;margin-top:4px;" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="42" style="padding-left:2px;padding-right:2px;">PERMIT<br/>
          NO.<br/>
          <strong>
		  	<s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null">
				5335
			</s:if>
			<s:else>
  ...
  <tr>
      ...
      <tr>
        <td height="21"><s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null "> &nbsp; </s:if>
