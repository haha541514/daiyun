    ...
    <table align="center" cellpadding="0" cellspacing="0" style=" border-collapse: collapse;width: 7.6cm;height: 8.2cm;" >
				    ...
				    <td height="5" colspan="3" style="border: 2px #000000 solid;height: 1cm;">
					    <div style="font-family:Arial, Helvetica, sans-serif;">
						    <div style="margin-left:0.3cm;">
								...
								<div align="left" style="float: left; margin-top:2px; margin-left:0.3cm;">
				...
				<tr>
			    	<td style="border: 2px #000000 solid;height: 1.5cm;">
				        <div style="font-family:Arial, Helvetica, sans-serif;width:3.8cm;height:1.2cm;margin-bottom:0px;">
				...
				<tr>
				    <td colspan="3" style="font-size:11px; border: 2px #000000 solid;height: auto; width:7cm;"> 
					    <div style="font-family:Arial, Helvetica, sans-serif;margin-bottom: 1px;width:270px;">
...
<table style="border:1px dashed #999999;width:7.6cm; height:8.2cm;border-collapse: collapse;" cellpadding="0" cellspacing="0"><tr><td ><table  align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 5px;marign-top:1px; border-collapse: collapse;font-size:13px;width:7.4cm;">
  <tr>
    ...
    <td align="right"><table width="142" style="border:1px #000000 solid;font-size:13px;text-align:center;padding-left:2px;margin-right:2px;margin-top:4px;" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="42" style="padding-left:2px;padding-right:2px;font-size:10px;">PERMIT<br/>
          NO.<br/>
          <strong>
            <s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null"> 5335 </s:if>
            <s:else>
  ...
  <table width="275" height="135"  align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        <td height="16" style="border-bottom:1px solid #000000;text-align:center;font-size:12px;">zone</td>
      </tr>
      <tr>
        <td height="16" style="font-size:12px;"><s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null "> &nbsp; </s:if>
        ...
        <s:else>
				...
				<td rowspan="2" align="right" valign="top"><table width="209" height="75" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font-weight:bold;marign-top:0px;">
                  <tr>
              ...
              <tr>
                <td height="40" valign="top"><table width="61" height="38" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #000000;font-size:13px;text-align:center;">
                    <tr>
                      <td width="60"  height="16" style="font-size:11px;">香港小包</td>
                    </tr>
                    <tr>
                      <td height="16" style="font-size:11px;">挂号</td>
                    </tr>
                </table></td>
              </tr>
              <tr>
		...
		<s:if test="#request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0">
			<s:if test="#request.listWayBillsBQ.size()==0 && #request.listWayBillsPY.size()==0">
				<s:if test="#request.listWayBillsOTS.size()==0 && #request.listWayBillsOTSR.size()==0">
					<s:if test="(#ghindex.index+1)!=#request.listWayBillsGH.size() && (#ghindex.index+1)%3==0">
			...
			<s:else>
				<s:if test="#request.listWayBillsOTS.size()==0 && #request.listWayBillsOTSR.size()==0">
					<s:if test="(#ghindex.index+1+(3-(#request.listWayBillsBQ.size()+#request.listWayBillsPY.size())%3)))%3==0 && (#ghindex.index+1)!=#request.listWayBillsGH.size()">
						<p style="page-break-after:always">&nbsp;</p>
					</s:if>
				</s:if>
				<s:else>
		...
		<s:else>
			...
			<s:else>
				<s:if test="(#ghindex.index+1+(3-(#request.listWayBillsBQ.size()+request.listWayBillsPY.size())%3))%3==0">
					<p style="page-break-after:always">&nbsp;</p>
				</s:if>
			</s:else>
		</s:else>			
