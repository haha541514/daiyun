...
<table align="left" style="border:1px dashed #999999;width:7.6cm; height:8.2cm;border-collapse: collapse;" cellpadding="0" cellspacing="0"><tr><td >
<table  align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 5px;marign-top:1px; border-collapse: collapse;font-size:13px;width:7.4cm;">
  <tr>
  ...
  <tr>
    <td colspan="2"><div align="left"  style="font-size:11px;"><span style="height:90px;">
  ...
  <table width="275" height="135"  align="center" cellpadding="1" cellspacing="1">
              <tr>
                <td valign="top" height="39"><table width="61" align="right" style="border:1px #000000 solid;text-align:center;font-weight:bold;" cellpadding="0" cellspacing="0">
      <tr>
      ...
      <tr>
        ...
        <s:else>
              ...
              <tr>
                <td height="37" valign="bottom"><table width="61" height="38" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #000000;font-size:13px;text-align:center;">
                    <tr>
	...
	<s:if test="#request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
		<s:if test="#request.listWayBillsBQ.size()==0 && #request.listWayBillsOTS.size()==0 && #request.listWayBillsPY.size()==0">
			<s:if test="(#ghindex.index+1)%6==0 && (#ghindex.index+1) != (#request.listWayBillsGH.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:if>	
		<s:else>
			<s:if test="(#ghindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size()+#request.listWayBillsPY.size())%6))%6==0 && (#ghindex.index+1) != (#request.listWayBillsGH.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>		
	</s:if>
	<s:else>
		...
		<s:else>
			<s:if test="(#ghindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size()+#request.listWayBillsPY.size())%6))%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>	
	</s:else>	
