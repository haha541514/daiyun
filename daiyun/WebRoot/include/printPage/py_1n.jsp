...
<table align="left" cellpadding="0" cellspacing="0" style="border:1px dashed #999999;width:7.6cm; height:8.2cm;border-collapse: collapse;">
  ...
  <table width="275" height="130"  align="center" cellpadding="1" cellspacing="1">
              <tr>
               <td height="39" valign="top" align="left" ><table width="61" height="38" cellpadding="0" cellspacing="0" style="border:1px solid #000000;font-size:13px;text-align:center;">
      <tr>
      ...
      <tr>
        ...
        <s:else>
              ...
              <tr>
                <td height="37" valign="bottom" ><table width="61" height="38" cellpadding="0" cellspacing="0" style="border:1px solid #000000;font-size:13px;text-align:center;">
                    <tr>
		...
		<s:if test="#request.listWayBillsGH.size()==0 && #request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
			<s:if test="#request.listWayBillsBQ.size()==0 && #request.listWayBillsOTS.size()==0">
				<s:if test="(#pyindex.index+1)%6==0 && (#pyindex.index+1) != (#request.listWayBillsPY.size())">
				  	<p style="page-break-after:always">&nbsp;</p>
				 </s:if>
			</s:if>	
		<s:else>
			<s:if test="(#pyindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size())%6))%6==0 && (#pyindex.index+1) != (#request.listWayBillsPY.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>		
	</s:if>
	<s:else>
		...
		<s:else>
			<s:if test="(#pyindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size())%6))%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>	
	</s:else>	
