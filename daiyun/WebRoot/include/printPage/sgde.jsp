...
<html>
  ...
  <body >
    <s:iterator var="totalSize" value="#request.listWayBillsSGDE" status="ghindex">
	 ...
	 <tr><td style="width:9.8cm;height:13.9cm;border:2px #000 solid;" valign="top">
       <table align="center" cellpadding="0" cellspacing="0" border="0">
         ...
         <s:set var="totalCicihscode" value="#totalCicihscode+#setCicihscode"  />
           ...
           <div style="float:left;height:1.7cm;width: 6cm;margin-top:0.1cm;margin-left:0.5cm;">
            <p style="border-bottom:1px #000 solid;width:5.2cm;text-align:center;"><b ><s:property value='#bean.Cwcw_serverewbcode' /></b></p>
           <img src="barcode.br?hrsize=0mm&type=code128&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" alt="条码" style="width: 5.2cm;height: 0.7cm;margin-top:0.1cm;" />
           <b>EINSCHREIBEN EINWURF</b> </div>
           </div></td></tr>
