...
<html>
  ...
  <body>
  <s:iterator var="totalSize" value="#request.listWayBillsSWISS" status="ghindex">
         ...
         <tr><td>
           <div style="width:9.6cm;heigth:2.5cm;margin-left:0.2cm;margin-right: 0.2cm;">
             ...
             <div style="float:left;width:5.8cm;height:2.5cm;"> 
               <img src="${pageContext.request.contextPath}/images/ppi.jpg" style="margin:0px;height:2.5cm;width:5.8cm;padding: 0px;display:block"/>
             </div>
           </div> 
         </td></tr>
         <tr>
