...
<html>
  ...
  <body style="margin:0px;">
    <s:iterator var="totalSize" value="#request.listWayBillsUDFORP" status="ghindex">
	 ...
	 <tr><td style="width:10cm;" valign="top">
       ...
       <tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif;">
        ...
        <div style="float:left;width:5.5cm;height:5cm;">
         <div style="width:5.4cm;TEXT-ALIGN: center;margin-top:0cm;" >     
         <table align="center" border="0" cellspacing="0" cellpadding="0"  style="width:5.2cm;margin-top:0.1cm;">
