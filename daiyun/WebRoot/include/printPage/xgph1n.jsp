...
<table style="border:1px dashed #999999;margin-top:0px; width:9cm; margin-bottom: 80px; border-collapse: collapse;margin-top: 1px;" cellpadding="0" cellspacing="0"><tr><td width="340" height="380">
			<table width="325" align="center" cellpadding="0" cellspacing="0" style="margin-top:0px; margin-bottom: 30px; border-collapse: collapsemargin-top: 1px; font-size:13px;">
  <tr>
    <td align="left" width="156"><table style="border:1px #000000 solid;font-size:13px;text-align:center;padding-left:5px;padding-right:5px;margin-top:4px;" cellpadding="0" cellspacing="0">
      <tr>
    ...
    <td align="right"><table width="146" style="border:1px #000000 solid;font-size:13px;text-align:center;padding-left:2px;padding-right:2px;margin-top:4px;" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="42" style="padding-left:2px;padding-right:2px;">PERMIT<br/>
          NO.<br/>
          <strong>
		  	<s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null">
				5335
			</s:if>
			<s:else>
		  		<s:property value="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)" />
			</s:else>
		  </strong>
		</td>
      </tr>
  ...
  <tr>
      ...
      <s:property value="#bean.Hwhw_consigneetelephone"/>
	        ...
	        <table width="325" align="center" cellpadding="1" cellspacing="1">
              <tr>
                <td valign="top"><table width="71" align="right" style="border:1px #000000 solid;text-align:center;font-weight:bold;" cellpadding="0" cellspacing="0">
      <tr>
        <td width="129" height="21" style="border-bottom:1px solid #000000;text-align:center;">zone</td>
      </tr>
      <tr>
        <td height="21"><s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null "> &nbsp; </s:if>
        <s:elseif test="(@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)).equals('')">&nbsp;</s:elseif>
        <s:else>
                <s:property value="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)" />
      	</s:else></td>
      </tr>
    </table></td>
				<td width="245" rowspan="2" valign="top"><table width="254" height="85" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font-weight:bold;">
                  <tr>
                    <td width="225" height="37" valign="bottom"><table width="237" style=" font-size:13px;font-weight:bold;text-align:left;" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="22" rowspan="2" style="font-size:30px;">R</td>
                        <td width="211" >HONG&nbsp;&nbsp;KONG</td>
                      </tr>
                      <tr>
                        <td height="15"><span>
                  ...
                  <tr>
                    <td height="30"><div align="left" style="margin-left:2px;"><img src="barcode.br?hrsize=0mm&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />" width="212" 
											style="width: 6.5cm;height: 1.1cm;" /></div></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td height="40" valign="top"><table width="71" height="38" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #000000;font-size:13px;text-align:center;">
                    <tr>
                      <td width="67" height="21">香港小包挂</td>
                    </tr>
                    <tr>
                      <td height="16">号</td>
                    </tr>
              ...
              <tr>
                <td colspan="2"><table align="center" width="326" style="border:1px solid #000000;font-size:13px;text-align:center;" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="68">【<s:property value="#bean.Ccoco_labelcode"/>】&nbsp;&nbsp;Ref&nbsp;&nbsp;No:&nbsp;&nbsp;<s:property value="#bean.Cwcw_customerewbcode"/></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
				<td style="font-size:13px;" colspan="3" align="left">
