...
<html>
  ...
  <body>
     <s:iterator var="totalSize" value="#request.listWayBillsGH" status="phindex">
    ...
    <table align="center" cellpadding="0" cellspacing="0" style=" border-collapse: collapse; border: 2px #000000 solid;width: 7.6cm;height: 8.2cm;" >
				...
				<tr>
				    <td colspan="3" style="font-size:11px; border: 2px #000000 solid;height: auto; width:7cm;"> 
					    <div style="font-family:Arial, Helvetica, sans-serif;margin-bottom: 5px;width:270px;">
...
<table align="center" style="border:1px dashed #999999;margin-top:0px; width:7.6cm; height:8.2cm;border-collapse: collapse;margin-top: 1px;" cellpadding="0" cellspacing="0"><tr><td ><table  align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 5px;marign-top:1px; border-collapse: collapse;font-size:13px;width:7.4cm;">
  <tr>
  ...
  <table width="275" height="135"  align="center" cellpadding="1" cellspacing="1">
              <tr>
                <td valign="top"><table width="61" height="38" align="right" style="border:1px #000000 solid;text-align:center;font-weight:bold;" cellpadding="0" cellspacing="0">
      <tr>
        <td height="16" style="border-bottom:1px solid #000000;text-align:center;font-size:13px;">zone</td>
      </tr>
      <tr>
        <td height="16" style="font-size:13px;"><s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)==null "> &nbsp; </s:if>
        ...
        <s:else>
				...
				<td rowspan="2" align="right" valign="top"><table width="209" height="79" cellpadding="0" cellspacing="0" style="border:1px solid #000000; font-weight:bold;marign-top:0px;">
                  <tr>
                    <td width="225" height="28" align="right" valign="bottom"><table width="210" style="marign-top:0px; font-size:13px;font-weight:bold;text-align:left;" cellpadding="0" cellspacing="0">
                      <tr>
                  ...
                  <tr>
                    <td height="25" valign="top"><div align="left" style="margin-left:2px;"><img src="barcode.br?hrsize=0mm&ewbcode_type=&msg=<s:property value='#bean.Cwcw_serverewbcode' />"  
		...
		<s:if test="#request.listWayBillsSGGH.size()==0 && #request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
      	<s:if test="(#phindex.index+1) != #request.listWayBillsGH.size()">
      		<p style="page-break-after:always">&nbsp;</p>
      	</s:if>
      </s:if>
      <s:else>
