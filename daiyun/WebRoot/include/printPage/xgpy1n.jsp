...
<table align="center" style="border:1px dashed #999999;margin-top:0px; margin-bottom: 80px; border-collapse: collapsemargin-top: 1px; font-size:13px;" cellpadding="0" cellspacing="0"><tr><td width="340" height="380"><table width="325" align="center" cellpadding="0" cellspacing="0">
    ...
    <td align="right"><table width="146" style="border:1px #000000 solid;font-size:13px;text-align:center;padding-left:2px;padding-right:2px;margin-top:4px;" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="42" style="padding-left:2px;padding-right:2px;">PERMIT<br/>
          NO.<br/>
		  <strong>
		  	<s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvenameByDistrict('3501', #bean.Cwdt_code_signin)==null">
				5335			</s:if>
			<s:else>
		  		<s:property value="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvenameByDistrict('3501', #bean.Cwdt_code_signin)" />
			</s:else>
		  </strong>		</td>
      </tr>
    </table></td>
  ...
  <tr>
      ...
      <table width="325" align="center" cellpadding="1" cellspacing="1">
        <tr>
          <td width="67"><table width="71" align="right" style="border:1px #000000 solid;text-align:center;font-weight:bold;" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td>
                <s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict('3602', #bean.Cwdt_code_signin)==null"> &nbsp; </s:if>
                <s:elseif test="(@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict('3602', #bean.Cwdt_code_signin)).equals('')">&nbsp;</s:elseif>
              <s:else>
                <s:property value="@kyle.leis.es.price.zone.dax.ZoneDemand@getHKZnvnameByDistrict('3602', #bean.Cwdt_code_signin)" />
            </s:else></td>
              </tr>
          </table></td>
	...
	<p style="page-break-after:always">&nbsp;</p>
  	...
  	<s:if test='(#ghindex.index+1) < #request.listWayBillsPY.size()'>
		<p style="page-break-after:always">&nbsp;</p>
	</s:if>
  </body>
</html>
