...
<table cellpadding="0" align="center" cellspacing="0" style="border:1px dashed #999999;width:7.6cm; height:8.2cm;border-collapse: collapse;">
  ...
  <tr>
    <td height="30">&nbsp;</td>
    <td valign="top" style="padding-top:2px;" align="right"><table width="142" height="28" cellpadding="0" cellspacing="0" style="border:1px solid #000000;margin-right:2px; font-weight:bold;font-size:12px; text-align:center;">
      <tr>
  ...
  <table width="275" height="135"  align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <s:else>
              ...
              <tr>
                <td height="38" valign="top"><div align="center"><img src="barcode.br?hrsize=0mm&ewbcode_type=&msg=<s:property value='#bean.Cwcw_ewbcode' />" style="width: 5cm;height: 0.9cm;" /></div></td>
              </tr>
          </table></td>
              </tr>
              <tr>
