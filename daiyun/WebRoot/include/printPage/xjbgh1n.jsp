...
<tr><td style="font-size:13px;" colspan="3" align="left">
	...
	<s:if test="#request.listWayBillsSGPY.size()==0 && #request.listWayBillsSWGH.size()==0 && #request.listWayBillsOTSR.size()==0">
		<s:if test="#request.listWayBillsBQ.size()==0 && #request.listWayBillsOTS.size()==0 && #request.listWayBillsPY.size()==0 && #request.listWayBillsGH.size()==0">
			<s:if test="(#ghindex.index+1)%6==0 && (#ghindex.index+1) != (#request.listWayBillsSGGH.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:if>	
		<s:else>
			<s:if test="(#ghindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size()+#request.listWayBillsPY.size()+#request.listWayBillsGH.size())%6))%6==0 && (#ghindex.index+1) != (#request.listWayBillsSGGH.size())">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>		
	</s:if>
	<s:else>
		...
		<s:else>
			<s:if test="(#ghindex.index+1+(6-(#request.listWayBillsBQ.size()+#request.listWayBillsOTS.size()+#request.listWayBillsPY.size()+#request.listWayBillsGH.size())%6))%6==0">
			  	<p style="page-break-after:always">&nbsp;</p>
			 </s:if>
		</s:else>	
	</s:else>
