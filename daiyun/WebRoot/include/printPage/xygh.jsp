...
<html>
  ...
  <table align="center" style="width:18cm;margin-bottom:1cm;"><tr><td align="left">
        ...
        <tr>
          <td valign="bottom"><table align="left" style="border:2px #000000 solid;text-align:center;font-weight:bold;width:0.9cm;height:1.6cm;" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <s:elseif test="(@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_R'), #bean.Cwdt_code_signin)).equals('')">&nbsp;
				</s:elseif>
              	<s:else>
          ...
          <td valign="bottom" align="right"><table cellpadding="0" cellspacing="0" style="border:2px solid #000000; font-weight:bold; width:6.4cm; height:1.6cm;">
              <tr>
                      <td valign="middle" align="right" style="font-size:12px;font-family:rial, Helvetica, sans-serif;"><span>
                        <s:property value="#bean.Cwcw_ewbcode"/>
                      </span>&nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td  valign="bottom" ><div align="right" style="margin-right:2px;margin-bottom:2px;"><img src="barcode.br?hrsize=0mm&ewbcode_type=&msg=<s:property value='#bean.Cwcw_ewbcode' />" width="212" style="width: 5cm;height: 0.8cm;" /></div></td>
              </tr>
          </table></td>
        </tr>
        <tr>
...
<td align="right"><table align="center" cellpadding="0" cellspacing="0" style=" border-collapse: collapse; border: 2px #000000 solid;width: 7.6cm;height: 8.2cm;" >
  <tr>
