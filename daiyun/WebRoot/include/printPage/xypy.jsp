        ...
        <tr>
          <td valign="bottom"><table align="left" style="border:2px #000000 solid;text-align:center;font-weight:bold;width:0.9cm;height:1.6cm;" cellpadding="0" cellspacing="0">
              <tr>
				...
				<s:if test="@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_NR'), #bean.Cwdt_code_signin)==null"> &nbsp; </s:if>
                <s:elseif test="(@kyle.leis.es.price.zone.dax.ZoneDemand@getZnvnameByDistrict(@kyle.leis.es.price.zone.dax.ZoneDemand@getZfCodeByCity('HK_NR'), #bean.Cwdt_code_signin)).equals('')">&nbsp;
				</s:elseif>
            	  <s:else>
