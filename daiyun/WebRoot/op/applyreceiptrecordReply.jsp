...
<script type="text/javascript">
 	function queryDate(){
 		document.getElementById("form1").action="${pageContext.request.contextPath}/applyreceiptrecordQuery";
...
<div id="main">
  <div id="top">
   ...
   <div style="border:1px dashed #0072E3； ">
    ...
    <a href="${pageContext.request.contextPath}/op/applyreceiptrecord.jsp"  style="font-size: 15px;color:#0072E3;font-weight: bold">新建申请</a> 		
...
<table width="800" border="0" id="isutable">
  <tr style=" background:#edf8fd;">
    <td style="width:40px">序号</td>
    <td style="width:60px">申请号</td>
    <td style="width:60px">申请状态</td>
    <td style="width:60px">领取方式</td>
    <td style="width:130px">申请时间</td>
    <td style="width:80x">申请人</td>
  ...
  <TBODY id="info">
  		<% int number=0; %>
       <s:iterator var="bean" value="#request.listApplyreceiptrecord" status="sts">
       			<% number++; %>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <TR>
							...
							<TD class="tab6"><s:property value="#bean.Tfarrcode"/></TD>
							<TD class="tab6"><a href="${pageContext.request.contextPath}/op/applyModifyQuery?arrcode=<s:property value="#bean.Tfarrcode"/>"  style=";color:#0072E3;"><s:property value="#bean.tdArsname"/></a></TD>
							<TD class="tab6"><s:property value="#bean.trRrtname"/></TD>
							<TD class="tab6"><s:property value="#bean.tfArrcreatedate"/></TD>
							<TD class="tab6"><s:property value="#bean.opOpname"/></TD>
							<TD  class="tab6"><s:property value="#bean.tfArrtaxpayerid"/></TD>
 							<TD  class="tab6"><s:property value="#bean.tfArrbankname"/></TD>
 							<TD  class="tab6"><s:property value="#bean.tfArrbankaccount"/></TD>
						</TR>
						</s:iterator>
						</TBODY>
						<!-- 判断定制块的值是否为空 -->
						<s:set var="queryAccount" value="#request.listApplyreceiptrecord" />
                    ...
                    <div class="page" style="padding-top:15px;padding-left:600px;" >
						<p:pager url="applyreceiptrecordQuery"  />
					</div>
					</s:if>		
		  </div>
        </div>
