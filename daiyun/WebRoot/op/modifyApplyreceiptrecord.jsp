...
<script type="text/javascript">
 	function refund(){
 		if(check()){
 			...
 			document.getElementById("form1").action="${pageContext.request.contextPath}/applyreceiptrecord?arscode=1&action=modify";
 	...
 	function submit2(){
 		if(check()){	
 			document.getElementById("form1").action="${pageContext.request.contextPath}/applyreceiptrecord?arscode=2&action=modify";
  			document.getElementById("form1").submit();
 		}
 	}
 	function change(){
 ...
 <form id="form1" name="form1" action="" method="post"  >
   <div class="forwarding">
    ...
    <div class="right">
       ...
       <div class="recharge">
        ...
        <div class="nir">
   <s:iterator var="bean" value="#request.ApplyreceiptrecordColumns" status="sts">
   <input name="arrcode"  id="arrcode"  type="hidden"  style="width:300px;" value="<s:property value="#bean.tfArrcode"/>"/>
  <table width="500" border="0" class="moneyback">
   ...
   <tr>
    <td style=" width:87px;">开户公司：</td>
 	 <td> <input name="companyName"  id="companyName"  type="text"  style="width:300px;" value="<s:property value="#bean.tfArrcompanyname"/>"/></td>
  </tr>
  <tr>
    <td style="width:87px;">纳税识别号：</td>
    <td> <input  name="payNumber" id="payNumber" type="text"   style="width:300px;" value="<s:property value="#bean.tfArrtaxpayerid"/>" /></td>
  </tr>
   <tr>
    <td style=" width:87px;">开户行：</td>
 	 <td> <input name="bankName"  id="bankName"  type="text"  style="width:300px;" value="<s:property value="#bean.tfArrbankname"/>" />  </td>
  </tr>
  <tr>
    <td style=" width:87px;">银行账号：</td>
 	 <td> <input name="bankAccount"  id="bankAccount"  type="text"  style="width:300px;" value="<s:property value="#bean.tfArrbankaccount"/>" /> </td>
  </tr>
  <s:if test="#bean.trRrtcode==2">
  <tr>
    ...
    <td><select name="invoiceType" id="invoiceType" style="width:150px;height:27px" onchange="mail()">
                  ...
                  <option value="2" selected="selected" >------邮寄------ </option>
                </select></td>
  </tr>
  <tr id="mail1">
  ...
  <tr id="mail2">
    <td style=" width:87px;">邮寄联系人：</td>
 	 <td> <input name="mailName"  id="mailName"  type="text"  style="width:300px;height:26x" value="<s:property value="#bean.tfArrmailedcontactperson"/>"/></td>
  </tr>
  <tr id="mail3">
    <td style=" width:87px;">邮寄地址：</td>
 	 <td><input name="mailAddress"  id="mailAddress"   style="width:300px;height:26x" value="<s:property value="#bean.tfArrmailedaddress"/>" /></td>
  </tr>
  <tr id="mail4" >
    <td style=" width:87px;">邮寄电话：</td>
 	 <td> <input name="mailTelephone"  id="mailTelephone"  type="text"  style="width:300px;" value="<s:property value="#bean.tfArrmailedtel"/>" /></td>
  </tr>
     <tr id="mail5" >
  ...
  <tr id="mail3"style="display:none">
    <td style=" width:87px;">邮寄地址：</td>
 	 <td><input name="maiilAddress"  id="mailAddress"   style="width:300px;height:26x"  /></td>
  </tr>
  <tr id="mail4" style="display:none">
    <td style=" width:87px;">邮寄电话：</td>
 	 <td> <input name="mailTelethone"  id="mailTelephone"  type="text"  style="width:300px;" /></td>
  </tr>
	...
	<s:if test="#bean.tdArscode==1">
	<button class="pro_button" type="button" onclick="refund();" >修改保存</button>
