...
<script type="text/javascript">
 	function refund(){
 		if(check()){
 			...
 			document.getElementById("form1").action="${pageContext.request.contextPath}/refundApply?rscode=1";
 	...
 	function submit2(){
 		if(check()){
 			document.getElementById("form1").action="${pageContext.request.contextPath}/refundApply?rscode=2";
  			document.getElementById("form1").submit();
  		}
 	}
 	function check(){
...
<div id="main">
 ...
 <form id="form1" name="form1" action="" method="post"  >
  ...
  <tr>
    ...
    <td> <textarea name="applyReason" id="applyReason" cols="" rows="8" style="width:300px; border:1px solid #adaeae; padding-left:2px;"></textarea></td>
  </tr>
   <tr>
