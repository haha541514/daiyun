...
<body>
    ...
    <div id="admin">    
	<div id="top"><img src="<%=path%>/m_images/logo.jpg" /> <span> 您现在的位置--<a href="<%=path%>/daiyun.jsp">首页---</a>会员中心--<a href="javascript:void(0)" onclick="JudgmentS('LEWFDIS');">网站前台</a></span>
	</div>
		<div class="master">
			...
			<div class="admin_rit_ads">
			    <div class="admin_ads_head">
				    ...
				    <div class="admin_piece_rit">
								...
								style="width:82px; height:28px; margin-left: 75px; background:url(<%=path %>/m_images/add.jpg); border:0px; " onclick="JudgmentS('LEWFDIS');" /> 
							--><input type="button" value="保 存"
								style="width:82px; height:28px; margin-left: 140px; background:url(<%=path %>/m_images/add.jpg); border:0px; " onclick="addAndUpdateGmenu()" />
							...
							<input onclick="goSubmenu();" type="button" id="submitCustom"
								value="子菜单" style="width:82px; height:28px; margin-left: 20px; background:url(<%=path %>/m_images/add.jpg); border:0px;" />
						</div>
