...
<body onload="changeTopmenu(5,650)">
<div id="main">
  <div id="top">
    <div class="top">
      <div class="window">
        <div class="left"></div>
        <div class="right"><span><a onclick="checkVlidateCode();" href="<%=path%>/login.jsp">登录</a></span> | <span><a href="<%=path%>/register.jsp">注册</a></span> | <span><a href="<%=path%>/op/recharge.jsp">充值</a></span> | <span><a href="#">English</a></span></div>
      </div>
      <div class="logo">
  ...
  <div id="page">
    ...
    <img alt="联系我们" src="<%=path%>/images/contact2.jpg" width="740" height="226">
