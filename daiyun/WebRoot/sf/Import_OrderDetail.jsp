  ...
  <div class="forwarding">
   ...
   <jsp:include page="../op/tree.jsp" />
      ...
      <div class="balance">
        ...
        <div class="nir">
        <p>日志编号：${importLog.toccwlid }，录入时间：${importLog.toccwlcreatedate }</p>
      ...
      <div class="button">
          <button class="buttonbg" value="" type="button" onclick="location.href='aliImportLog'">返回</button>
        </div>
        ...
        <table width="860" border="0">
          <thead style="background:#edf8fd;">	
                   		<tr>	 
							...
							<td width="50" class="tab4"><strong>是否成功</strong></td>
							<td width="140" class="tab4"><strong>备注</strong></td>
						</tr>													
			</thead>
			<tbody id="info">
						...
						<s:iterator var="bean" value="#request.results" status="stat">						
								<td width="10" ><s:property value="#bean.Cwbrcomp_idcwbrid" /></td>									
								<td width="30" >
									<s:if test='"Y".equals(#bean.Cwbrcwbrsuccesssign)'>导入成功</s:if>
									<s:else><font color="red">导入失败</font></s:else>
								</td>													
