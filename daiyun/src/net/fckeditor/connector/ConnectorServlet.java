...
public class ConnectorServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!RequestCycleHandler.isEnabledForFileUpload(request))
			ur = new UploadResponse(new Object[]{UploadResponse.SC_SECURITY_ERROR, null, null,
			        Messages.NOT_AUTHORIZED_FOR_UPLOAD});
		else if (!CommandHandler.isValidForPost(commandStr))
			ur = new UploadResponse(new Object[]{UploadResponse.SC_ERROR, null, null, Messages.INVALID_COMMAND});
		else if (typeStr != null && !ResourceTypeHandler.isValid(typeStr))
			ur = new UploadResponse(new Object[]{UploadResponse.SC_ERROR, null, null, Messages.INVALID_TYPE});
		else if (!UtilsFile.isValidPath(currentFolderStr))
				...
				try {
					...
					if (!ExtensionsHandler.isAllowed(resourceType, extension))
						...
						if (Utils.isEmpty(newFilename))
							ur = new UploadResponse(new Object[]{UploadResponse.SC_OK, UtilsResponse
